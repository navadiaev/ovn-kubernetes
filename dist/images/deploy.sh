./daemonset.sh --image-pull-policy=Always --image=docker.io/navadiaev/ovn-daemonset-f:latest --net-cidr=172.16.0.0/16 --svc-cidr=10.96.0.0/12 --gateway-mode="shared" --ovnkube-node-mgmt-port-netdev=ens259f0v0 --k8s-apiserver=https://10.5.210.201:6443 --multicast-enabled --disable-snat-multiple-gws --disable-pkt-mtu-check=true
